...
for n_k in range(9):
    ...
    parser.add_argument('--opt', type=str, default='options/test/test_stage3.yml', help='Path to options YMAL file.')
    ...
    for test_loader in test_loaders:
        ...
        prepro = util.SRMDPreprocessing(opt['scale'], random=False, l=opt['kernel_size'], add_noise=opt['test_noise'],
                                        ...
                                        sig1=sigma1, sig2=sigma2, theta=theta,
        ...
        for test_data in test_loader:
            ...
            if not real_image:
                ...
                mae_k = util.calculate_kernel_MAE(est_ker, gt_ker)
                ssim_k = util.calculate_kernel_ssim(est_ker * 255, gt_ker * 255)
            ...
            mae_K_ac += mae_k
            ssim_K_ac += ssim_k
        psnr_k_list.append(psnr_K_ac / 14)
        mae_k_list.append(mae_K_ac / 14)
        ssim_k_list.append(ssim_K_ac / 14)
...
print('Estimated kernel PSNR:', psnr_k_list)
print('Estimated kernel MAE:', mae_k_list)
print('Estimated kernel SSIM:', ssim_k_list)

print('average kernel MAE:', np.mean(mae_k_list))
print('average kernel SSIM:', np.mean(ssim_k_list))
